...
class Members::ShopTest < ApplicationSystemTestCase
  ...
  test "only shop special delivery" do
    ...
    visit "/"
    assert_selector "nav li[data-test-shop-menu]", text: "⤷ 4 April 2024"
    assert_selector "nav li[data-test-shop-menu]", text: "⤷ 5 April 2024" # Special
  end
  ...
  test "menu only for session originated from admin" do
    ...
    visit "/"
    assert_no_selector "nav li[data-test-shop-menu]"

    members(:jane).sessions.last.update!(admin: admins(:ultra))

    visit "/"
    assert_selector "nav li[data-test-shop-menu]"
  end
  ...
  test "open to members" do
    ...
    visit "/"
    assert_selector "nav li[data-test-shop-menu]", text: "⤷ 11 April 2024"
  end
  ...
  test "special delivery only open to member with specific depots" do
    ...
    visit "/"
    assert_no_selector "nav li[data-test-shop-menu]", text: "⤷ 5 April 2024" # Special
  end
end
