...
- `bin/rails lint:check` / `bin/rails lint:autocorrect` — style checks and fixes; optional paths limit which linters run (`bin/rails lint:check app/models/foo.rb app/javascript/bar.js`)
