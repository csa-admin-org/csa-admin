...
describe BasketsBasketComplement do
  it 'validates that price is zero when basket complement has an annual price type', freeze: '2022-01-01' do
    create(:delivery, date: '2022-01-20')
    membership = create(:membership)
    membership.reload
    basket_complement = create(:basket_complement, :annual_price_type, id: 1)
