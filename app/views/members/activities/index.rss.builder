...
xml.rss version: "2.0" do
  xml.channel do
    xml.title t("members.activity_participations.index.coming_activity_participations")
    ...
    if @activities.empty?
      xml.item do
        xml.title t("members.activity_participations.index.no_coming_activity_participations")
      end
    end
  end
end
