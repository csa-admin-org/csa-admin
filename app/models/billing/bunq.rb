...
module Billing
  # bunq bank connection client for fetching incoming payments.
  #
  # This client authenticates with bunq using stored credentials (generated by
  # the bunq:setup rake task) and fetches payments that can be matched against
  # invoices via their SCOR reference.
  #
  # Usage:
  #   client = Billing::Bunq.new(org.bank_credentials)
  #   client.payments_data # => Array of PaymentData structs
  #
  class Bunq
