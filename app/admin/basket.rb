...
ActiveAdmin.register Basket do
  ...
  form do |f|
    ...
    if f.object.shifted?
      panel t(".basket_shift_title"), class: "mb-8 border-teal-200 bg-teal-100 dark:border-teal-800 dark:bg-teal-950", action: handbook_icon_link("absence", anchor: "basket-shift") do
      ...
      if f.object.can_be_shifted?
        panel t(".basket_shift_title"), class: "mb-8 list-none border-teal-200 bg-teal-100 dark:border-teal-800 dark:bg-teal-950", action: handbook_icon_link("absence", anchor: "basket-shift") do
          div class: "px-2 -mb-2" do
