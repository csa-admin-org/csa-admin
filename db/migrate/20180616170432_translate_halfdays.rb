...
class TranslateHalfdays < ActiveRecord::Migration[5.2]
  def change
    ...
    HalfdayPreset.find_each do |halfday_preset|
      places = org.languages.map { |l| [ l, halfday_preset[:place] ] }.to_h
      place_urls = org.languages.map { |l| [ l, halfday_preset[:place_url] ] }.to_h
      activities = org.languages.map { |l| [ l, halfday_preset[:activity] ] }.to_h
    ...
    Halfday.find_each do |halfday|
      places = org.languages.map { |l| [ l, halfday[:place] ] }.to_h
      place_urls = org.languages.map { |l| [ l, halfday[:place_url] ] }.to_h
      activities = org.languages.map { |l| [ l, halfday[:activity] ] }.to_h
      descriptions = org.languages.map { |l| [ l, halfday[:description] ] }.to_h
      halfday.update!(
        places: places,
        place_urls: place_urls,
        activities: activities,
